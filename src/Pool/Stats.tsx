    ...
    <div className="pool-stats__token-info">
        <div className="pool-stats__token-main">
          ...
          <div>
            ...
            <div className="pool-stats__token-percentage">{ token.percentage }%</div>
          </div>
        </div>

        <div className="pool-stats__token-value-ratio">1 {token.name} = {token.ratio.amount} {token.ratio.name}</div>
    </div>
      ...
      <div className="pool-stats__main">
        <Uik.Container flow="spaceBetween">
          ...
          >
            ...
            <span className="pool-stats__pool-select-name">{ data.token1.name } / { data.token2.name }</span>
          </button>
        ...
        <Uik.Container className="pool-stats__main-stats">
          <div className="pool-stats__main-stat">
            ...
            <div className="pool-stats__main-stat-value">${ data.totalValueLocked }</div>
          </div>

          <div className="pool-stats__main-stat">
            <div className="pool-stats__main-stat-label">My Liquidity</div>
            <div className="pool-stats__main-stat-value">${ data.myLiquidity }</div>
          </div>
